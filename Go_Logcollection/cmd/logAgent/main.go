...
import (
	...
	"Go_Logcollection/cmd/logAgent/conf"
	"Go_Logcollection/pkgs/etcd"
	"Go_Logcollection/pkgs/kafka"
	"Go_Logcollection/pkgs/logger"
	"Go_Logcollection/pkgs/taillog"
	"Go_Logcollection/utils"
...
func main() {
	...
	//fmt.Println(cfg.LogConf.FileName)
